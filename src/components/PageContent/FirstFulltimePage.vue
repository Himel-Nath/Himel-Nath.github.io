  ...
  <div class="parchment-wrapper">
    <div class="book-theme">
      ...
      <blockquote class="page-text hidden-text quote">
        “Himel is a highly productive worker and exceeded all my expectations for quality and
        quantity of work from a student on his co-op term. He shows great problem-solving skills, a
        keen desire to learn, and has a great work ethic. He would do well in pretty much any web
        development job.”
        <footer>- Supervisor, SimplyCast</footer>
      </blockquote>

      <p class="hidden-text page-text">
        They weren't wrong. It was never supposed to be permanent. But when he left, something had
        already been set in motion. They had plans for him and he had unfinished business.
      </p>
      <p class="hidden-text page-text">
      ...
      <blockquote class="page-text hidden-text quote">
        “I felt supported throughout my work term… he always checked up on me.”
